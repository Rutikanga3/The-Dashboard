  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-2 mt-4 text-black text-md'>
        ...
        <Link to="/assignments" className={`flex items-center gap-2 p-3 rounded-md hover:${theme === "dark" ? "bg-gray-700" : "bg-gray-100"
          }`}>
        ...
        <Link to="/categories" className={`flex items-center gap-2 p-3 rounded-md hover:${theme === "dark" ? "bg-gray-700" : "bg-gray-100"
          }`}>
